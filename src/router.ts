...
function buildRouterPrompt(enabledFunctions: FunctionName[]): string {
  ...
  return [
    ...
    'If the user directly asks the bot light chat, wellbeing/check-in, encouragement, persona, thanks, or reassurance, return {"action":"small_talk","arguments":{"category":"wellbeing|thanks|encouragement|reassurance|persona|light_joke"}}.',
